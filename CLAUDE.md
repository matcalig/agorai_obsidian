...
## System Purpose
*Matteo's vault. Focus areas: **Career & Professional** and **Personal Growth**.*

*Mission statement: to be written — a sentence that ties your career ambitions to how you want to grow as a person. Draft it during a weekly or monthly review, then replace this line.*

## Working with Matteo
- **When teaching/explaining:** short and concise. Lead with the answer.
- **When acting as a thought partner:** challenge assumptions and keep me in check — don't just agree.
...
Primary areas: **Career & Professional**, **Personal Growth**.
See @Goals/2. Monthly Goals.md for this month's priorities (still to be filled in).
